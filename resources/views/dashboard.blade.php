                ...
                <div class="grid grid-cols-3 grid-rows-2 p-0 gap-2 justify-items-center items-center">
                    ...
                    <div class="p-4 w-full">
                        <a href="/questions" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                            <img class="object-cover w-full rounded-t-lg h-120 md:h-60 md:w-20 md:rounded-none md:rounded-l-lg" src="/questions.png" alt="">
                    ...
                    <div class="p-4 w-full">
                        <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                            <img class="object-cover w-full rounded-t-lg h-120 md:h-60 md:w-20 md:rounded-none md:rounded-l-lg" src="/answer.jpeg" alt="">
                            <div class="flex flex-col justify-between p-4 leading-normal">
                    ...
                    <div class="p-4 w-full">
                        <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                            <img class="object-cover w-full rounded-t-lg h-120 md:h-60 md:w-20 md:rounded-none md:rounded-l-lg" src="/total_votes.jpeg" alt="">
                            <div class="flex flex-col justify-between p-4 leading-normal">
                    ...
                    <!-- Second row //-->
                    <div class="p-4 w-full">
                        <a href="/questions/{{ $results?->highest_vote['id'] }}/votes" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                            <img class="object-cover w-full rounded-t-lg h-120 md:h-60 md:w-20 md:rounded-none md:rounded-l-lg" src="/answer.jpeg" alt="">
                            <div class="flex flex-col justify-between p-4 leading-normal">
                    ...
                    <div class="p-4 w-full">
                        <a href="/questions/{{ $results?->highest_question['id'] }}/votes" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                            <img class="object-cover w-full rounded-t-lg h-120 md:h-60 md:w-20 md:rounded-none md:rounded-l-lg" src="/questions.png" alt="">
                            <div class="flex flex-col justify-between p-4 leading-normal">
                    ...
                    <div class="p-4 w-full">
                        <a href="/questions/{{ $results?->most_voted_question['id'] }}/votes" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                            <img class="object-cover w-full rounded-t-lg h-120 md:h-60 md:w-20 md:rounded-none md:rounded-l-lg" src="/questions.png" alt="">
                            <div class="flex flex-col justify-between p-4 leading-normal">
