<x-app-layout>
    ...
    <div class="py-5">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-3 grid-rows-2 p-0 gap-2 justify-items-center">
                    <!-- First row //-->
                    <div class="p-4 w-full h-full col-span-1 flex flex-col">
                        <a href="/questions" class="h-full w-full flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
